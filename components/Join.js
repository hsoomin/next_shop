        ...
        <div className="signWrap">
            <form  action="/api/auth/signup" method="POST">
                <ul>
                    <li className='id-section'>
                        <div className='area-style'>
                            ...
                            <input type="text" name="idArea" id="idArea" className='input-style' required size={20} value={id} onBlur={handleId} onChange={(event)=>{setId(event.target.value)}} ref={idInputRef}/>
                    ...
                    <li className='pw-section'>
                        <div className='area-style'>
                            ...
                            <input type="password" name="password" id="pwArea" className='input-style' required size={20} value={pw} onBlur={handlePw} onChange={(event)=>{setPw(event.target.value)}} ref={pwInputRef}/>
                            ...
                            <input type="password" name="pw2Area" id="pw2Area" className='input-style' required size={20} value={pw2} onBlur={handlePw2} onChange={(event)=>{setPw2(event.target.value)}} ref={pw2InputRef}/>
                    ...
                    <li className='name-section'>
                        <div className='area-style'>
                            ...
                            <input type="text" name="nameArea" id="nameArea" className="input-style" required size="20" value={name} onBlur={handleName} onChange={(event)=>{setName(event.target.value)}} ref={nameInputRef}/>
                    ...
                    <li className='phone-section'>
                        <div className='area-style'>
                            ...
                            <div className="select-box">
                                ...
                                &nbsp; - &nbsp;
                                <input type="text" name="phoneArea" id="phoneArea" className="input-select-style" required size="20" value={phone} onBlur={handlePhone} onChange={(event)=>{setPhone(event.target.value)}} ref={phoneInputRef}></input>
                            </div>
                    ...
                    <li className='birth-section'>
                        <div className='area-style'>
                            ...
                            id="birthArea" className="input-style" required size="8" value={birth} maxlength="8" onBlur={handleBirth} onChange={(event)=>{setBirth(event.target.value)}} ref={birthInputRef}/>
                ...
                <div className="terms-all-check">
                    ...
                    <strong htmlFor="allCheck">이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</strong>
                </div>
                <ul className="terms-section">
                    <li className="terms-list">
                        <h3 className="terms-title">[필수] 이용약관 동의</h3>
                        ...
                        <div className="terms-agree">
                            <span className="agree-left">이용약관에 동의하십니까? </span>
                    ...
                    <li className="terms-list">
                        <h3 className="terms-title">[필수] 개인정보 수집 및 이용 동의</h3>
                        <div className="terms-desc">
                            ■ 수집하는 개인정보 항목
                            <br/>
                            회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                        ...
                        <div className="terms-agree">
                            <span className="agree-left">개인정보 수집 및 이용에 동의하십니까? </span>
                            <div className="agree-right">
                    ...
                    <li className="terms-list">
                        <h3 className="terms-title">[필수] 쇼핑정보 수신 동의</h3>
                        <div className="terms-desc">
                            ■ 수집하는 개인정보 항목
                            <br/>
                            회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                        ...
                        <div className="terms-agree">
                            <span className="agree-left">SMS 수신을 동의하십니까? </span>
                            <div className="agree-right">
